...
public class Media extends VLCObject<IMedia.Event> implements IMedia {
    ...
    public Media(ILibVLC ILibVLC, FileDescriptor fd, long offset, long length) {
        super(ILibVLC);
        nativeNewFromFdWithOffsetLength(ILibVLC, fd, offset, length);
        mUri = VLCUtil.UriFromMrl(nativeGetMrl());
    }
    ...
    /* JNI */
    private native void nativeNewFromCryptPath(ILibVLC ILibVLC, String path);
