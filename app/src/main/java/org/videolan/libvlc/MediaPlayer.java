...
//    }
    ...
    public native void previousChapter();
    public native void nextChapter();
    ...
    /* JNI */
    public native void nativeSetTime(long time);
    public native void nativeSetPosition(float pos);
